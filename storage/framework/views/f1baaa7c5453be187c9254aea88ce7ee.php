    ...
    <article class="panel is-primary">
        ...
        <div class="customContainer">
            ...
            <div class="columns">
                <div class="column is-9">
                    <div class="field">
                        <?php echo e(Html::label('Task Details', 'task_details', array('class' => 'label'))); ?>

                        <div class="control">
                            <?php echo e(Html::input('textarea','task_details', $task->task_details ?? NULL, ['class' => 'textarea', 'rows' => 5, 'placeholder' => 'Enter task details...'])); ?>
