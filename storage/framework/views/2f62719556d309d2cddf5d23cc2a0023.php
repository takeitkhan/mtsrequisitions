...
<!DOCTYPE html>
<html class="has-navbar-fixed-top" lang="<?php echo e(app()->getLocale()); ?>">
...
<body>
    ...
    <div class="columns">
        <?php if(!empty($__env->yieldContent('column_left')) && !empty($__env->yieldContent('column_right'))): ?>
    ...
    <div
        ...
        <a class="onhover" href="https://www.mathmozo.com" target="_blank">
            Mathmozo IT
        </a>
    </div>
    <style type="text/css">
...
</html><?php /**PATH D:\oldwindows\laragon\www\mtsrequisitions\resources\views/layouts/app.blade.php ENDPATH**/ ?>