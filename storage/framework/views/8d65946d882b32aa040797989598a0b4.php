            ...
            <?php if(auth()->user()->isResource(auth()->user()->id)): ?>
                ...
                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($task->user_id == auth()->user()->id || $task->site_head == auth()->user()->id): ?>
                        <?php echo $__env->make('task::tasklist.index_template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\oldwindows\laragon\www\mtsrequisitions\vendor\tritiyo\task\src/views/index.blade.php ENDPATH**/ ?>