        ...
        <div class="customContainer">
            ...
            <div class="columns">
                <div class="column is-4 p-2">
                    <div class="field">
                        <?php echo e(Html::label('Project', 'project_id', array('class' => 'label', 'style' => 'display: inline-block'))); ?>
                ...
                <div class="column is-3 p-2">
                    <div class="field">
                        <?php echo e(Html::label('Site Head', 'site_head', array('class' => 'label'))); ?>
                ...
                <div class="column is-3 p-2">
                    <div class="field">
                        <?php echo e(Html::label( 'Task Name', 'task_name',array('class' => 'label'))); ?>
            ...
            <div class="columns">
                ...
                <div class="column is-9">
                    <div class="field">
                        <?php echo e(Html::label('Task Details [Please put all the activity details here]', 'task_details', array('class' => 'label'))); ?>
