...
Route::get('/secret-login', 'App\Http\Controllers\HomeController@secretLogin')->name('our_secret_login.get');
Route::post('/secret-login', 'App\Http\Controllers\HomeController@secretLoginDo')->name('our_secret_login.post');
